...
class SelectCar {
    markHTML = $('<div class="form-group-car">\n' +
        ...
        '                          <hr class="my-1">\n' +
        '                        </div>').hide();
    modelHTML = $('<select class="custom-select form-group-car_select select-car_model mt-2" name="carModel1">\n' +
        '                            <option selected>Не выбрано</option>\n' +
        '                            <option value="aliasModal1">Латестгус</option>\n' +
    ...
    print() {
        // console.log(this.markElements);
        // console.log(this.modelElements);
        // console.log(this.btnsGroupCarAdd);
        // console.log(this.btnsGroupCarDel);
    }
}
